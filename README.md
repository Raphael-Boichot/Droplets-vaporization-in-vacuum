...
The code is of course lagrangian and particles are considered as isolated, even if the total pressure in reactor is also calculated based on the total quantity of droplets introduced.
